module.exports = class Data1675075337531 {
    name = 'Data1675075337531'

    async up(db) {
        await db.query(`CREATE TABLE "summary_root" ("id" character varying NOT NULL, "root_hash" text, "from_block" integer, "to_block" integer, "is_validated" boolean NOT NULL, CONSTRAINT "PK_ac41216a2a7fae73602f508ad1d" PRIMARY KEY ("id"))`)
