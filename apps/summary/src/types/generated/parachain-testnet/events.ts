...
export class SummarySummaryCalculatedEvent {
  ...
  get isV4(): boolean {
    return (
      this._chain.getEventHash('Summary.SummaryCalculated') ===
      'd1cf622a2d4f0c9130bb329e159dbcd0de92f74598f25f1ab36f28ba39c26d02'
    )
  }
...
export class SummaryVotingEndedEvent {
  ...
  get isV4(): boolean {
    return (
      this._chain.getEventHash('Summary.VotingEnded') ===
      '2a4efe74aab1ffd5fcafc5f773bdd4dc53c70f2abd2cfb39fec0b244681c1ab3'
    )
  }
