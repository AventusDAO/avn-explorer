...
export async function getChainStateFromBlock(
...
export async function setChainState(ctx: BatchContext<Store, unknown>, block: SubstrateBlock) {
  const state = await getChainStateFromBlock(ctx, block)
