...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV61(): {who: Uint8Array, free: bigint} {
        assert(this.isV61)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     * Dispatched some task.
     */
    get asV61(): {task: [number, number], id: (Uint8Array | undefined), result: v61.Type_108} {
        assert(this.isV61)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerAvtLoweredEvent {
    ...
    get asV44(): {sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array} {
        assert(this.isV44)
        return this._chain.decodeEvent(this.event)
    }
    ...
    get asV57(): {sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV57)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerLowerRequestedEvent {
    ...
    get asV57(): {tokenId: Uint8Array, from: Uint8Array, amount: bigint, t1Recipient: Uint8Array, senderNonce: (bigint | undefined), lowerId: number, scheduleName: Uint8Array} {
        assert(this.isV57)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenLoweredEvent {
    ...
    get asV57(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV57)
        return this._chain.decodeEvent(this.event)
    }
}
