...
export class BalancesAccountStorage extends StorageBase {
     ...
     *  NOTE: This is only used in the case that this pallet is used to store balances.
     */
    get asV61(): BalancesAccountStorageV61 {
        assert(this.isV61)
        return this as any
    }
}
 ...
 *  NOTE: This is only used in the case that this pallet is used to store balances.
 */
export interface BalancesAccountStorageV61 {
    get(key: Uint8Array): Promise<v61.AccountData>
    getAll(): Promise<v61.AccountData[]>
    getMany(keys: Uint8Array[]): Promise<v61.AccountData[]>
    getKeys(): Promise<Uint8Array[]>
    getKeys(key: Uint8Array): Promise<Uint8Array[]>
    getKeysPaged(pageSize: number): AsyncIterable<Uint8Array[]>
    getKeysPaged(pageSize: number, key: Uint8Array): AsyncIterable<Uint8Array[]>
    getPairs(): Promise<[k: Uint8Array, v: v61.AccountData][]>
    getPairs(key: Uint8Array): Promise<[k: Uint8Array, v: v61.AccountData][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: Uint8Array, v: v61.AccountData][]>
    getPairsPaged(pageSize: number, key: Uint8Array): AsyncIterable<[k: Uint8Array, v: v61.AccountData][]>
}
...
export class SystemAccountStorage extends StorageBase {
     ...
     *  The full account information for a particular account ID.
     */
    get asV61(): SystemAccountStorageV61 {
        assert(this.isV61)
        return this as any
    }
}
 ...
 *  The full account information for a particular account ID.
 */
export interface SystemAccountStorageV61 {
    get(key: Uint8Array): Promise<v61.AccountInfo>
    getAll(): Promise<v61.AccountInfo[]>
    getMany(keys: Uint8Array[]): Promise<v61.AccountInfo[]>
    getKeys(): Promise<Uint8Array[]>
    getKeys(key: Uint8Array): Promise<Uint8Array[]>
    getKeysPaged(pageSize: number): AsyncIterable<Uint8Array[]>
    getKeysPaged(pageSize: number, key: Uint8Array): AsyncIterable<Uint8Array[]>
    getPairs(): Promise<[k: Uint8Array, v: v61.AccountInfo][]>
    getPairs(key: Uint8Array): Promise<[k: Uint8Array, v: v61.AccountInfo][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: Uint8Array, v: v61.AccountInfo][]>
    getPairsPaged(pageSize: number, key: Uint8Array): AsyncIterable<[k: Uint8Array, v: v61.AccountInfo][]>
}
