...
export class TokenManagerTokenLiftedEvent {
    ...
    get asV70(): {tokenId: Uint8Array, recipient: Uint8Array, tokenBalance: bigint, ethTxHash: Uint8Array} {
        assert(this.isV70)
...
export class TokenManagerTokenLoweredEvent {
    ...
    get asV70(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV70)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenTransferredEvent {
    ...
    get asV70(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, tokenBalance: bigint} {
        assert(this.isV70)
        return this._chain.decodeEvent(this.event)
    }
}
