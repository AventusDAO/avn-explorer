...
export class TokenManagerTokenLiftedEvent {
  ...
  get asV10(): {tokenId: Uint8Array, recipient: Uint8Array, tokenBalance: bigint, ethTxHash: Uint8Array} {
    assert(this.isV10)
...
export class TokenManagerTokenLoweredEvent {
  ...
  get asV10(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array} {
    assert(this.isV10)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class TokenManagerTokenTransferredEvent {
  ...
  get asV10(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, tokenBalance: bigint} {
    assert(this.isV10)
    return this._chain.decodeEvent(this.event)
  }
}
