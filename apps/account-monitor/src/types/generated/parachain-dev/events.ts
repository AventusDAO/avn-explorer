...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV58(): {who: Uint8Array, free: bigint, reserved: bigint} {
        assert(this.isV58)
...
export class BalancesDepositEvent {
     ...
     * Some amount was deposited (e.g. for transaction fees).
     */
    get asV58(): {who: Uint8Array, amount: bigint} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV58(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * Final argument indicates the destination balance type.
     */
    get asV58(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v58.BalanceStatus} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesTransferEvent {
     ...
     * Transfer succeeded.
     */
    get asV58(): {from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EthBridgeEventAcceptedEvent {
    ...
    get asV70(): {ethEventId: v70.EthEventId} {
        assert(this.isV70)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EthBridgeEventRejectedEvent {
    ...
    get asV70(): {ethEventId: v70.EthEventId, reason: v70.DispatchError} {
        assert(this.isV70)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchCreatedEvent {
     ...
     * batch_id, total_supply, batch_creator, provenance
     */
    get asV58(): {batchNftId: bigint, totalSupply: bigint, batchCreator: Uint8Array, authority: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchNftMintedEvent {
     ...
     * nft_id, batch_id, provenance, owner
     */
    get asV58(): {nftId: bigint, batchNftId: bigint, authority: Uint8Array, owner: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerEthNftTransferEvent {
     ...
     * EthNftTransfer(NftId, NewOwnerAccountId, NftSaleType, u64, EthEventId),
     */
    get asV58(): {nftId: bigint, newOwner: Uint8Array, saleType: v58.NftSaleType, opId: bigint, ethEventId: v58.EthEventId} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerFiatNftTransferEvent {
     ...
     * FiatNftTransfer(NftId, SenderAccountId, NewOwnerAccountId, NftSaleType, NftNonce)
     */
    get asV58(): {nftId: bigint, sender: Uint8Array, newOwner: Uint8Array, saleType: v58.NftSaleType, opId: bigint} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerSingleNftMintedEvent {
    ...
    get asV58(): {nftId: bigint, owner: Uint8Array, authority: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerCanceledEvent {
     ...
     * Canceled some task.
     */
    get asV58(): {when: number, index: number} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     * Dispatched some task.
     */
    get asV58(): {task: [number, number], id: (Uint8Array | undefined), result: v58.Type_91} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
...
export class TokenManagerAvtLiftedEvent {
    ...
    get asV58(): {recipient: Uint8Array, amount: bigint, ethTxHash: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerAvtLoweredEvent {
    ...
    get asV58(): {sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerLowerRequestedEvent {
    ...
    get asV58(): {tokenId: Uint8Array, from: Uint8Array, amount: bigint, t1Recipient: Uint8Array, senderNonce: (bigint | undefined), lowerId: number, scheduleName: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenLiftedEvent {
    ...
    get asV58(): {tokenId: Uint8Array, recipient: Uint8Array, tokenBalance: bigint, ethTxHash: Uint8Array} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenLoweredEvent {
    ...
    get asV58(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenTransferredEvent {
    ...
    get asV58(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, tokenBalance: bigint} {
        assert(this.isV58)
        return this._chain.decodeEvent(this.event)
    }
}
