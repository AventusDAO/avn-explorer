...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV31(): {who: Uint8Array, free: bigint, reserved: bigint} {
        assert(this.isV31)
...
export class BalancesDepositEvent {
     ...
     * Some amount was deposited (e.g. for transaction fees).
     */
    get asV31(): {who: Uint8Array, amount: bigint} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV31(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * Final argument indicates the destination balance type.
     */
    get asV31(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v31.BalanceStatus} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesTransferEvent {
     ...
     * Transfer succeeded.
     */
    get asV31(): {from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchCreatedEvent {
     ...
     * batch_id, total_supply, batch_creator, provenance
     */
    get asV31(): {batchNftId: bigint, totalSupply: bigint, batchCreator: Uint8Array, authority: Uint8Array} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchNftMintedEvent {
     ...
     * nft_id, batch_id, provenance, owner
     */
    get asV31(): {nftId: bigint, batchNftId: bigint, authority: Uint8Array, owner: Uint8Array} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerEthNftTransferEvent {
     ...
     * EthNftTransfer(NftId, NewOwnerAccountId, NftSaleType, u64, EthEventId),
     */
    get asV31(): {nftId: bigint, newOwner: Uint8Array, saleType: v31.NftSaleType, opId: bigint, ethEventId: v31.EthEventId} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerFiatNftTransferEvent {
     ...
     * FiatNftTransfer(NftId, SenderAccountId, NewOwnerAccountId, NftSaleType, NftNonce)
     */
    get asV31(): {nftId: bigint, sender: Uint8Array, newOwner: Uint8Array, saleType: v31.NftSaleType, opId: bigint} {
        assert(this.isV31)
        return this._chain.decodeEvent(this.event)
    }
}
