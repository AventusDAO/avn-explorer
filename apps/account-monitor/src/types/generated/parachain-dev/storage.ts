...
export class BalancesAccountStorage extends StorageBase {
     ...
     *  NOTE: This is only used in the case that this pallet is used to store balances.
     */
    get asV58(): BalancesAccountStorageV58 {
        assert(this.isV58)
        return this as any
    }
 ...
 *  NOTE: This is only used in the case that this pallet is used to store balances.
 */
export interface BalancesAccountStorageV58 {
    get(key: Uint8Array): Promise<v58.AccountData>
    getAll(): Promise<v58.AccountData[]>
    getMany(keys: Uint8Array[]): Promise<v58.AccountData[]>
    getKeys(): Promise<Uint8Array[]>
    getKeys(key: Uint8Array): Promise<Uint8Array[]>
    getKeysPaged(pageSize: number): AsyncIterable<Uint8Array[]>
    getKeysPaged(pageSize: number, key: Uint8Array): AsyncIterable<Uint8Array[]>
    getPairs(): Promise<[k: Uint8Array, v: v58.AccountData][]>
    getPairs(key: Uint8Array): Promise<[k: Uint8Array, v: v58.AccountData][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: Uint8Array, v: v58.AccountData][]>
    getPairsPaged(pageSize: number, key: Uint8Array): AsyncIterable<[k: Uint8Array, v: v58.AccountData][]>
}
...
export class SystemAccountStorage extends StorageBase {
     ...
     *  The full account information for a particular account ID.
     */
    get asV58(): SystemAccountStorageV58 {
        assert(this.isV58)
        return this as any
    }
 ...
 *  The full account information for a particular account ID.
 */
export interface SystemAccountStorageV58 {
    get(key: Uint8Array): Promise<v58.AccountInfo>
    getAll(): Promise<v58.AccountInfo[]>
    getMany(keys: Uint8Array[]): Promise<v58.AccountInfo[]>
    getKeys(): Promise<Uint8Array[]>
    getKeys(key: Uint8Array): Promise<Uint8Array[]>
    getKeysPaged(pageSize: number): AsyncIterable<Uint8Array[]>
    getKeysPaged(pageSize: number, key: Uint8Array): AsyncIterable<Uint8Array[]>
    getPairs(): Promise<[k: Uint8Array, v: v58.AccountInfo][]>
    getPairs(key: Uint8Array): Promise<[k: Uint8Array, v: v58.AccountInfo][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: Uint8Array, v: v58.AccountInfo][]>
    getPairsPaged(pageSize: number, key: Uint8Array): AsyncIterable<[k: Uint8Array, v: v58.AccountInfo][]>
}
