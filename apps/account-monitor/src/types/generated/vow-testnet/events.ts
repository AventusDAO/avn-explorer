...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV5(): {who: Uint8Array, free: bigint} {
        assert(this.isV5)
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV5(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * Final argument indicates the destination balance type.
     */
    get asV5(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v5.BalanceStatus} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesTransferEvent {
     ...
     * Transfer succeeded.
     */
    get asV5(): {from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EthBridgeEventAcceptedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'EthBridge.EventAccepted')
        this._chain = ctx._chain
        this.event = event
    }

    get isV5(): boolean {
        return this._chain.getEventHash('EthBridge.EventAccepted') === '0c0e791e31e5907e91a5fc110f808eb12f3e5a5c2f94d0f2a81432401206f22d'
    }

    get asV5(): {ethEventId: v5.EthEventId} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}

export class EthBridgeEventRejectedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'EthBridge.EventRejected')
        this._chain = ctx._chain
        this.event = event
    }

    get isV5(): boolean {
        return this._chain.getEventHash('EthBridge.EventRejected') === 'e9bbba0f0ad8b178703bbd8faebf526d0b0d057bea276aba8446550a96a2b6d0'
    }

    get asV5(): {ethEventId: v5.EthEventId, reason: v5.DispatchError} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchCreatedEvent {
     ...
     * batch_id, total_supply, batch_creator, provenance
     */
    get asV6(): {batchNftId: bigint, totalSupply: bigint, batchCreator: Uint8Array, authority: Uint8Array} {
        assert(this.isV6)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerBatchNftMintedEvent {
     ...
     * nft_id, batch_id, provenance, owner
     */
    get asV6(): {nftId: bigint, batchNftId: bigint, authority: Uint8Array, owner: Uint8Array} {
        assert(this.isV6)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerEthNftTransferEvent {
     ...
     * EthNftTransfer(NftId, NewOwnerAccountId, NftSaleType, u64, EthEventId),
     */
    get asV6(): {nftId: bigint, newOwner: Uint8Array, saleType: v6.NftSaleType, opId: bigint, ethEventId: v6.EthEventId} {
        assert(this.isV6)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerFiatNftTransferEvent {
     ...
     * FiatNftTransfer(NftId, SenderAccountId, NewOwnerAccountId, NftSaleType, NftNonce)
     */
    get asV6(): {nftId: bigint, sender: Uint8Array, newOwner: Uint8Array, saleType: v6.NftSaleType, opId: bigint} {
        assert(this.isV6)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftManagerSingleNftMintedEvent {
    ...
    get asV6(): {nftId: bigint, owner: Uint8Array, authority: Uint8Array} {
        assert(this.isV6)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     * Dispatched some task.
     */
    get asV5(): {task: [number, number], id: (Uint8Array | undefined), result: v5.Type_39} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerAvtLiftedEvent {
    ...
    get asV5(): {recipient: Uint8Array, amount: bigint, ethTxHash: Uint8Array} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerAvtLoweredEvent {
    ...
    get asV5(): {sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerLowerRequestedEvent {
    ...
    get asV5(): {tokenId: Uint8Array, from: Uint8Array, amount: bigint, t1Recipient: Uint8Array, senderNonce: (bigint | undefined), lowerId: number, scheduleName: Uint8Array} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenLiftedEvent {
    ...
    get asV5(): {tokenId: Uint8Array, recipient: Uint8Array, tokenBalance: bigint, ethTxHash: Uint8Array} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenLoweredEvent {
    ...
    get asV5(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, amount: bigint, t1Recipient: Uint8Array, lowerId: number} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokenManagerTokenTransferredEvent {
    ...
    get asV5(): {tokenId: Uint8Array, sender: Uint8Array, recipient: Uint8Array, tokenBalance: bigint} {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TokensTransferEvent {
     ...
     */
    get isV13(): boolean {
        return this._chain.getEventHash('Tokens.Transfer') === '16035424e713058663b3b2e76d1bb1ff6caffc54e009403c5594f30eaa99962a'
    }

    /**
     * Transfer succeeded.
     */
    get asV13(): {currencyId: v13.Asset, from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
