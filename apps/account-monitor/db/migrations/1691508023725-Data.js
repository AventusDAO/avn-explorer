module.exports = class Data1691508023725 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE INDEX "IDX_f6e64c228ad00b8dbdf0afec05" ON "nft_transfer" ("relayer_id") `)
        await db.query(`CREATE INDEX "IDX_2329c9c1414a868706f9c2483b" ON "nft_transfer" ("nonce") `)
        await db.query(`CREATE INDEX "IDX_c53243bf2b970f2133e46c67bd" ON "token_transfer" ("relayer_id") `)
        await db.query(`CREATE INDEX "IDX_8d8e30d2fbac29e746147f25b4" ON "token_transfer" ("nonce") `)
