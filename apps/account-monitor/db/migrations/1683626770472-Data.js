module.exports = class Data1683626770472 {
    name = 'Data1683626770472'

    async up(db) {
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "from" text, "to" text, "amount" numeric(80,0) NOT NULL, "token_id" text, "transfer_type" character varying(20) NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
