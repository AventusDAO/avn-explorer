module.exports = class Data1671642068370 {
    name = 'Data1671642068370'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "staked_amount_total" numeric(80,0) NOT NULL, "rewards_total" numeric(80,0) NOT NULL, "updated_at" integer, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
    }
