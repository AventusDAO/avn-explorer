...
export class ParachainStakingNominationEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.Nomination') ===
      '2063c0fb05ba11ddf19d3efa92f92ca2d86fd1708621d08368bae26580469161'
    )
  }
  ...
  get asV12(): {
    ...
    nominatorPosition: v12.NominatorAdded
  } {
    assert(this.isV12)
...
export class ParachainStakingNominationDecreasedEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominationDecreased') ===
      'dd4415be8010a91cb1ca6fd47832e7344c34ccb86c4ec0514293b4121131b56f'
    )
  }
...
export class ParachainStakingNominationIncreasedEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominationIncreased') ===
      'dd4415be8010a91cb1ca6fd47832e7344c34ccb86c4ec0514293b4121131b56f'
    )
  }
...
export class ParachainStakingNominationKickedEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominationKicked') ===
      '3420396624af842b4d7d1627f45b38cda24d741906d874ca592ebdba548a702a'
    )
  }
...
export class ParachainStakingNominationRevokedEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominationRevoked') ===
      '3420396624af842b4d7d1627f45b38cda24d741906d874ca592ebdba548a702a'
    )
  }
...
export class ParachainStakingNominatorLeftEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominatorLeft') ===
      'bd751a1c7aa30b0b784c355a6a3893803e93a535025b780c3858483ecadaa460'
    )
  }
...
export class ParachainStakingNominatorLeftCandidateEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.NominatorLeftCandidate') ===
      '4bdd3b14fca150d54e80b11abde71312183de8bc09b57b745efac04308497901'
    )
  }
...
export class ParachainStakingRewardedEvent {
  ...
  get isV12(): boolean {
    return (
      this._chain.getEventHash('ParachainStaking.Rewarded') ===
      '1a005a96fdd51900b5609e011c697b2588490316080f642724ed18b187dfc5e5'
    )
  }
