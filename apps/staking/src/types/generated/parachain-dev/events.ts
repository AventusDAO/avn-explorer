...
export class ParachainStakingNominationEvent {
     ...
     * New nomination (increase of the existing one).
     */
    get asV21(): {nominator: Uint8Array, lockedAmount: bigint, candidate: Uint8Array, nominatorPosition: v21.NominatorAdded} {
        assert(this.isV21)
...
export class ParachainStakingNominationDecreasedEvent {
    ...
    get asV21(): {nominator: Uint8Array, candidate: Uint8Array, amount: bigint, inTop: boolean} {
        assert(this.isV21)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ParachainStakingNominationKickedEvent {
     ...
     * Nomination kicked.
     */
    get asV21(): {nominator: Uint8Array, candidate: Uint8Array, unstakedAmount: bigint} {
        assert(this.isV21)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ParachainStakingNominatorLeftEvent {
     ...
     * Nominator has left the set of nominators.
     */
    get asV21(): {nominator: Uint8Array, unstakedAmount: bigint} {
        assert(this.isV21)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ParachainStakingNominatorLeftCandidateEvent {
     ...
     * Nomination from candidate state has been remove.
     */
    get asV21(): {nominator: Uint8Array, candidate: Uint8Array, unstakedAmount: bigint, totalCandidateStaked: bigint} {
        assert(this.isV21)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ParachainStakingRewardedEvent {
     ...
     * Paid the account (nominator or collator) the balance as liquid rewards.
     */
    get asV21(): {account: Uint8Array, rewards: bigint} {
        assert(this.isV21)
        return this._chain.decodeEvent(this.event)
    }
}
