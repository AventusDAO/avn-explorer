...
export class MigrationMigrateSystemAccountCall {
  ...
  get isV4(): boolean {
    return (
      this._chain.getCallHash('Migration.migrate_system_account') ===
      '8f752997770c549f5b2110f1fefa80bf1ce3e4cfb892e26a4d0ccb769acf1202'
    )
  }
   ...
   * off-chain.
   */
  get asV4(): { accounts: [Uint8Array, Uint8Array][] } {
    assert(this.isV4)
