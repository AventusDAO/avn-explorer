...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV73(): {who: Uint8Array, free: bigint} {
        assert(this.isV73)
...
export class BalancesDepositEvent {
     ...
     * Some amount was deposited (e.g. for transaction fees).
     */
    get asV73(): {who: Uint8Array, amount: bigint} {
        assert(this.isV73)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV73(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV73)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * Final argument indicates the destination balance type.
     */
    get asV73(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v73.BalanceStatus} {
        assert(this.isV73)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesTransferEvent {
     ...
     * Transfer succeeded.
     */
    get asV73(): {from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV73)
        return this._chain.decodeEvent(this.event)
    }
}
