module.exports = class Data1669042353144 {
  name = 'Data1669042353144'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "balance" ("id" character varying NOT NULL, "free" numeric(80,0) NOT NULL, "reserved" numeric(80,0) NOT NULL, "total" numeric(80,0) NOT NULL, "updated_at" integer, "account_id" text NOT NULL, CONSTRAINT "PK_079dddd31a81672e8143a649ca0" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "free" numeric(80,0) NOT NULL, "reserved" numeric(80,0) NOT NULL, "total" numeric(80,0) NOT NULL, "updated_at" integer, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
  }
